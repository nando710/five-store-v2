...
const app = express();
const PORT = process.env.PORT || 3000; // Nixpacks/Coolify uses PORT
...
// ── FRONTEND SERVING ────────────────────────────────────────────────────────
// Serves the pre-built Vite application (React App)
...
app.listen(PORT, '0.0.0.0', () => {
    console.log(`✅ Server (API + Frontend) rodando na porta ${PORT}`);
